...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Learn how Scroll News uses machine learning to analyze U.S. headlines, highlight key people and places, and how the platform evolved from our early NLP projects." />
        ...
        <meta property="og:url" content="https://scrollnews.io/about.php" />
        ...
        <meta name="twitter:url" content="https://scrollnews.io/about.php" />
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                <h2 class="section-heading text-uppercase">About Scroll News</h2>

                <h3 class="section-subheading" style="margin-bottom: 2.25rem;">
                  <strong><span style="font-style: normal;">Scroll News is a personal news intelligence layer.</span></strong>
                </h3>

              </div>
            </div>

            <!-- New middle copy (keeps your current section layout, adds “our story” without changing template) -->
            <div class="row justify-content-center" style="margin-bottom: 2.5rem;">
              <div class="col-md-8">
            ...
            <div class="row text-center">
              <div class="col-md-4">
                ...
                <h4 class="my-3">U.S. News</h4>
                <p class="text-muted">
                  Scroll News focuses on U.S. coverage — built for people who live here, or anyone who wants a clear view of what’s happening.
                </p>
              </div>
              ...
              <div class="col-md-4">
                ...
                <h4 class="my-3">Signal</h4>
                <p class="text-muted">
                  A fast way to catch the day’s active headlines and the stories that are picking up momentum — without the chaos.
                </p>
              </div>
              ...
              <div class="col-md-4">
                ...
                <h4 class="my-3">Insight</h4>
                <p class="text-muted">
                  Natural language processing highlights key people, places, and themes — so you can see patterns across stories at a glance.
                </p>
              </div>
            </div>
          </div>
