    ...
    <div class="container my-5">
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-body p-5">
                ...
                <section class="how-philosophy">
                    <h4>Our Philosophy</h4>

                    <p class="philosophy-line">
                        <strong>No ads. No outrage.</strong>
                        Just information — organized.
                    </p>

                    <p>
                        Scroll News is designed to help you understand coverage without being pushed,
                        distracted, or pulled into endless reaction cycles.
                    </p>
                </section>
