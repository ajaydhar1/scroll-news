...
<html lang="en">
    <head>
        ...
        <meta property="og:url" content="https://scrollnews.io/privacy.php" />
        ...
        <meta name="twitter:url" content="https://scrollnews.io/privacy.php" />
    ...
    <body id="page-top">
        ...
        <!-- Content area--> 
        <div class="container py-5 bg-white rounded shadow-sm mt-4">
            <h1 class="mb-4">Privacy Policy</h1>
            <p><strong>Last Updated:</strong> August 1, 2025</p>

            <p>Scroll News respects your privacy. This policy outlines how we handle any information we collect when you use our site.</p>

            <h4>1. Data We Collect</h4>
            <p>We do <strong>not</strong> collect personal information such as names or email addresses at this time. Basic non-personal analytics may be used to understand general site usage, such as page views or device/browser type.</p>

            <h4>2. Cookies</h4>
            <p>Scroll News may use minimal cookies to enhance performance and user experience. You can disable cookies in your browser settings if you prefer.</p>

            <h4>3. Third-Party Links</h4>
            <p>Some content may link to external sites. We are not responsible for the privacy practices or content of those third-party websites.</p>

            <h4>4. Updates to This Policy</h4>
            <p>We may update this policy as needed. Continued use of Scroll News implies acceptance of any changes.</p>

            <h4>5. Contact</h4>
            <p>If you have any questions or concerns about this Privacy Policy, please contact us at <a href="mailto:your@email.com">your@email.com</a>.</p>
          </div>
