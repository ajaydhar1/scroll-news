...
<html lang="en">
    <head>
        ...
        <!-- Canonical + favicon -->
        <link rel="canonical" href="https://scrollnews.ai/terms" />
        <link rel="icon" type="image/png" href="/assets/img/play-green.png" />

        <!-- Open Graph -->
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://scrollnews.ai/terms" />
        ...
        <meta property="og:image" content="https://scrollnews.ai/assets/img/og/og-scrollnews-terms-1200x630.png" />

        <!-- Twitter -->
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://scrollnews.ai/terms" />
        ...
        <meta name="twitter:image" content="https://scrollnews.ai/assets/img/og/og-scrollnews-terms-1200x630.png" />
            ...
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-body p-5">
                    ...
                    <p class="lead">
                        ...
                        (scrollnews.ai), you agree to be bound by these Terms and Conditions.
                    </p>
