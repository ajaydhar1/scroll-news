        ...
        <footer class="footer py-4 bg-white sticky-top sn-top-nav">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left"><a href="index.php" data-loading>Home</a></div>
                    <div class="col-lg-4 my-3 my-lg-0">
                        ...
                        <a data-step="3" data-intro="Click here to see our newsroom video trailer." class="btn btn-black btn-social mx-2" href="control-room.php"><i class="fas fa-align-left"></i></a>
                    </div>
                    <div class="col-lg-4 text-lg-right" style=""><a href="about.php">About</a></div>
                </div>
            </div>
        </footer>